    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {activeCategories.map((category) => (
          <article key={category.id} className="group overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950/70 transition hover:-translate-y-1 hover:border-white/20">
