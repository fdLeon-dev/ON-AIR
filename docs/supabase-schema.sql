...
values
  ('Conjuntos Deportivos', 'conjuntos-deportivos', 'Colecciones completas de ropa deportiva', '/featured-1.jpg', 1, true),
  ('Accesorios', 'accesorios', 'Complementos para tu entrenamiento', '/featured-2.jpg', 2, true)
